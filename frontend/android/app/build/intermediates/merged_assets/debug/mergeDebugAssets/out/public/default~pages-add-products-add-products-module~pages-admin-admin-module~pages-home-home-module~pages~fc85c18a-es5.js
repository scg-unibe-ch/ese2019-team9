    ...
    ForgotPasswordComponent.prototype.onSubmitGetPassword = function () {
        ...
        this.authService.forgotPassword(val.email)
            ...
            if (error.status === 500) {
                ...
                _this.forgotPasswordForm.reset();
                _this.message = 'Have you entered the correct address?';
            }
        });
    };
    ...
    RegistrationComponent.prototype.onSubmitRegistration = function () {
        ...
        this.authService.register(val.email, val.password)
            ...
            if (error.status === 409) {
                ...
                _this.message = 'Registration failed';
            }
        });
    };
...
var CategoryMenuComponent = /** @class */ (function () {
    ...
    CategoryMenuComponent.ctorParameters = function () { return [
...
var TopHeaderEndComponent = /** @class */ (function () {
    function TopHeaderEndComponent(popoverController, authService, popoverService, router) {
        this.popoverController = popoverController;
        this.authService = authService;
        this.popoverService = popoverService;
        this.router = router;
    }
    TopHeaderEndComponent.prototype.ngOnInit = function () { };
...
var TopHeaderComponent = /** @class */ (function () {
    ...
    TopHeaderComponent.prototype.navigateHome = function () {
...
var PopoverService = /** @class */ (function () {
    ...
    PopoverService.prototype.dismissPopover = function () {
...
//# sourceMappingURL=default~pages-add-products-add-products-module~pages-admin-admin-module~pages-home-home-module~pages~fc85c18a-es5.js.map