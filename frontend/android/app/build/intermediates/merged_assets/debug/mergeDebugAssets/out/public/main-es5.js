...
var map = {
	"./pages/add-products/add-products.module": [
		...
		"default~pages-add-products-add-products-module~pages-admin-admin-module~pages-home-home-module~pages~fc85c18a",
		"pages-add-products-add-products-module"
	],
	"./pages/admin/admin.module": [
		"./src/app/pages/admin/admin.module.ts",
		"default~pages-add-products-add-products-module~pages-admin-admin-module~pages-home-home-module~pages~fc85c18a",
		"default~pages-admin-admin-module~pages-subcategory-subcategory-module",
		"pages-admin-admin-module"
	],
...
module.exports = "<ion-app>\n  <ion-menu side=\"start\" #menu menuId=\"m1\">\n    <ion-header>\n      <ion-toolbar color=\"primary\">\n        <ion-title>\n          Menu\n        </ion-title>\n      </ion-toolbar>\n    </ion-header>\n    <ion-content>\n      <ion-list>\n          <ion-item *ngIf=\"auth.isLoggedIn() && auth.isAdmin()\" routerLink=\"/admin\" [routerDirection]=\"'root'\">\n              <ion-icon name=\"settings\" slot=\"start\"></ion-icon>\n              <ion-label>Admin</ion-label>\n          </ion-item>\n          <span *ngFor=\"let category of categories\">\n            <ion-item lines=\"none\" (click)=\"showSubMenu(category)\">\n              <ion-label> {{ category.name }}</ion-label>\n              <ion-icon *ngIf=\"!category.showMenu\" name=\"arrow-dropdown\"></ion-icon>\n              <ion-icon *ngIf=\"category.showMenu\" name=\"arrow-dropleft\"></ion-icon>\n            </ion-item>\n            <div *ngIf=\"category.showMenu\">\n                <ion-list *ngFor=\"let subcategory of currentMenuSubcategories\">\n                    <ion-item (click)=\"subMenuItemClicked(category)\" [routerLink]=\"['/subcategory/', subcategory.slug]\" lines=\"none\">\n                        <ion-label> {{ subcategory.name }}</ion-label>\n                    </ion-item>\n                </ion-list>\n            </div>\n          </span>\n          <ion-item routerLink=\"/\">\n              <ion-icon name=\"wallet\" slot=\"start\"></ion-icon>\n              <ion-label>Become a Seller</ion-label>\n          </ion-item>\n          <ion-item *ngIf=\"auth.isLoggedIn()\" routerLink=\"/add-products\" [routerDirection]=\"'root'\">\n              <ion-icon name=\"add\" slot=\"start\"></ion-icon>\n              <ion-label>Add product</ion-label>\n          </ion-item>\n      </ion-list>\n    </ion-content>\n  </ion-menu>\n  <ion-router-outlet main></ion-router-outlet>\n</ion-app>\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, auth, categoryService) {
...
var AuthService = /** @class */ (function () {
    function AuthService(httpClient, router) {
        ...
        this.router = router;
        this.loginEndpoint = 'https://moln-api.herokuapp.com/user/login';
        this.registrationEndpoint = 'https://moln-api.herokuapp.com/user/signup';
        this.verificationEndpoint = 'https://moln-api.herokuapp.com/user/verify';
        this.resendEndpoint = 'https://moln-api.herokuapp.com/user/resend';
        this.forgotPasswordEndpoint = 'https://moln-api.herokuapp.com/user/forgot';
        this.resetEndpoint = 'https://moln-api.herokuapp.com/user/reset';
    }
    AuthService.prototype.register = function (email, password) {
        var _this = this;
        return this.httpClient.post(this.registrationEndpoint, { email: email, password: password }, this.httpOptions)
    ...
    AuthService.prototype.login = function (email, password) {
        var _this = this;
        return this.httpClient.post(this.loginEndpoint, { email: email, password: password }, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
    ...
    AuthService.prototype.verifyUser = function (token) {
        return this.httpClient.patch(this.verificationEndpoint, { token: token }, { observe: 'response' });
    };
    AuthService.prototype.resendEmail = function () {
        var id = localStorage.getItem('id');
        var email = localStorage.getItem('email');
        return this.httpClient.post(this.resendEndpoint, { id: id, email: email }, { observe: 'response' });
    };
    AuthService.prototype.forgotPassword = function (email) {
        return this.httpClient.post(this.forgotPasswordEndpoint, { email: email }, { observe: 'response' });
    };
    AuthService.prototype.resetPassword = function (token, password) {
        return this.httpClient.patch(this.resetEndpoint, { token: token, password: password }, { observe: 'response' });
    };
...
var CategoryService = /** @class */ (function () {
    function CategoryService(httpClient, router) {
        this.httpClient = httpClient;
        this.router = router;
        this.getCategoriesEndpoint = 'https://moln-api.herokuapp.com/category';
    }
    /*
