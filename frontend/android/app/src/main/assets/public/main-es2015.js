...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, auth, categoryService) {
...
let AuthService = class AuthService {
    ...
    register(email, password) {
        return this.httpClient.post(this.registrationEndpoint, { email, password }, this.httpOptions)
    ...
    login(email, password) {
        return this.httpClient.post(this.loginEndpoint, { email, password }, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => {
            this.setSession(res);
            return res;
        }));
