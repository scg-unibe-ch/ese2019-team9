...
let ProfileInformationsComponent = class ProfileInformationsComponent {
    constructor(userService, productService, progressIndicatorService) {
    ...
    displaySuccessSignifiers(typeOfProfileItem) {
    ...
    displayFailureSignifiers(typeOfProfileItem) {
        this.progressIndicatorService.dismissLoadingIndicator();
    ...
    retrieveNewProfileInformation() {
        if (this.typeOfProfileItem === this.typeOfUser) {
            this.userService.getSingleUser(this.profileItem._id).subscribe((data) => {
        ...
        if (this.typeOfProfileItem === this.typeOfProduct) {
            this.productService.getSingleProduct(this.profileItem._id).subscribe((data) => {
                this.profileItem = data;
                // @ts-ignore
                this.profileItemData = Object.keys(this.profileItem).filter(value => this.valuesToHide.indexOf(value) === -1);
                this.profileItemData.sort();
...
//# sourceMappingURL=default~pages-add-products-add-products-module~pages-admin-admin-module~pages-my-orders-my-orders-mo~cbac2fd6-es2015.js.map