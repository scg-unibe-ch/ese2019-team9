...
let ForgotPasswordComponent = class ForgotPasswordComponent {
     ...
     */
    constructor(formBuilder, authService, popoverController) {
 ...
 */
let HeaderButtonsComponent = class HeaderButtonsComponent {
    /**
     ...
     */
    constructor(popoverController, authService, notificationService) {
        this.popoverController = popoverController;
        this.authService = authService;
...
HeaderButtonsComponent.ctorParameters = () => [
...
let ProductService = class ProductService {
    ...
    updateProduct(productId, body, img) {
        const token = this.authService.getToken();
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', 'Bearer: ' + token);
...
let HomeBannerComponent = class HomeBannerComponent {
    constructor(categoryService, productService, progressIndicatorService, filterAndSearchService, popoverController) {
        this.categoryService = categoryService;
    ...
    onSearchbarChange(evt) {
        ...
        if (searchableArray.length > 0) {
            let searchResults = this.filterAndSearchService.searchUnique(searchableArray, value, undefined, false, ['id', '_id', 'toRevise', 'verified', 'image']);
    ...
    presentPopover(ev) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const popoverElement = yield this.popoverController.create({
...
HomeBannerComponent.ctorParameters = () => [
...
let SearchResultComponent = class SearchResultComponent {
    ...
    getAppOfResult(resultAppereance) {
        let res = '';
...
//# sourceMappingURL=default~pages-add-products-add-products-module~pages-admin-admin-module~pages-home-home-module~pages~c8f7aabb-es2015.js.map