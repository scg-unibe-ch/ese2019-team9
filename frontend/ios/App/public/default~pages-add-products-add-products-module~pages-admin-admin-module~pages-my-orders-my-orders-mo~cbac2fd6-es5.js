(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-add-products-add-products-module~pages-admin-admin-module~pages-my-orders-my-orders-mo~cbac2fd6"],{
...
/***/ "./node_modules/raw-loader/index.js!./src/app/shared/components/image-picker/image-picker.component.html":
/*!******************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/shared/components/image-picker/image-picker.component.html ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div [className]=\"profilePicker ? 'profilePicker' : 'picker'\">\n    <ion-img [className]=\"profilePicker ? 'profileImage' : 'image'\" *ngIf=\"selectedImage\" role=\"button\"  (click)=\"onPickImage()\"\n             [src]=\"selectedImage\" ></ion-img>\n    <ion-button fill=\"empty\" color=\"primary\" class=\"blueButton\" (click)=\"onPickImage()\" *ngIf=\"!selectedImage\">\n        <ion-icon name=\"camera\" slot=\"start\"></ion-icon>\n        <ion-label *ngIf=\"!preSelectedImage\" >Select Picture</ion-label>\n    </ion-button>\n</div>\n<input type=\"file\" *ngIf=\"usePicker\" #filePicker (change)=\"onFileChosen($event)\"/>\n\n"
...
module.exports = "<span *ngFor=\"let rating of ' '.repeat(flooredRating - (flooredRating % 1)).split(''), let x = index\">\n  <ion-icon class=\"rating\" name=\"star\"></ion-icon>\n</span>\n<span *ngIf=\"!((flooredRating % 1) === 0)\">\n  <ion-icon class=\"rating\" name=\"star-half\"></ion-icon>\n</span>\n<span *ngFor=\"let rating of ' '.repeat(5 - ceiledRating).split(''), let x = index\">\n  <ion-icon class=\"rating\" name=\"star-outline\"></ion-icon>\n</span>\n"
...
var UserService = /** @class */ (function () {
    function UserService(httpClient, authService) {
        ...
        this.userEndpoint = 'https://moln-api.herokuapp.com/user';
    }
    ...
    UserService.prototype.updateUser = function (id, body, img) {
        ...
        return this.httpClient.patch(this.userEndpoint + ("/" + id), formData, { headers: headers });
    };
    ...
    UserService.prototype.isSeller = function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var id = _this.authService.getId();
            _this.getSingleUser(id).subscribe(function (data) {
                if (data.address && data.address.length > 0 && data.country
                    && data.country.length > 0 && data.name && data.name.length > 0) {
                    resolve(true);
                }
                resolve(false);
            }, function (error) {
...
/***/ "./src/app/shared/components/image-picker/image-picker.component.scss":
/*!****************************************************************************!*\
  !*** ./src/app/shared/components/image-picker/image-picker.component.scss ***!
  \****************************************************************************/
/*! no static exports found */
...
module.exports = ".picker {\n  width: 100%;\n  height: 100%;\n  border: 1px solid var(--ion-color-primary);\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n          align-items: center;\n}\n\n.profilePicker {\n  heigth: 100%;\n  width: 100%;\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-pack: center;\n          justify-content: center;\n  align-content: center;\n  -webkit-box-align: center;\n          align-items: center;\n}\n\n.image {\n  width: 100%;\n  height: 100%;\n  -o-object-fit: cover;\n     object-fit: cover;\n}\n\n.profileImage {\n  min-height: 64px;\n  min-width: 64px;\n  border-radius: 50% !important;\n  overflow: hidden;\n}\n\ninput[type=file] {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/shared/components/image-picker/image-picker.component.ts":
/*!**************************************************************************!*\
  !*** ./src/app/shared/components/image-picker/image-picker.component.ts ***!
  \**************************************************************************/
...
var ImagePickerComponent = /** @class */ (function () {
    ...
    ImagePickerComponent.prototype.resetImage = function () {
    ...
    ], ImagePickerComponent.prototype, "preSelectedImage", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Boolean)
    ], ImagePickerComponent.prototype, "profilePicker", void 0);
    ImagePickerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-image-picker',
            template: __webpack_require__(/*! raw-loader!./image-picker.component.html */ "./node_modules/raw-loader/index.js!./src/app/shared/components/image-picker/image-picker.component.html"),
            styles: [__webpack_require__(/*! ./image-picker.component.scss */ "./src/app/shared/components/image-picker/image-picker.component.scss")]
        }),
...
module.exports = ".row {\n  border-bottom: 1px solid var(--ion-color-medium-shade);\n}\n\n.cursor-pointer {\n  cursor: pointer;\n}\n\n.hidden {\n  display: none;\n}\n\nion-input {\n  --padding-top:0;\n  --padding-bottom:0;\n  border: 1px solid black;\n}\n\n.warning {\n  border: 4px solid var(--ion-color-warning);\n}\n\n.success {\n  border: 4px solid var(--ion-color-success);\n}\n\n.error {\n  border: 4px solid var(--ion-color-danger);\n}\n\n:host ion-input {\n  --padding-top: 0;\n}\n\n.deleteProductButton {\n  position: absolute;\n  right: 20px;\n}\n\n.additionalInformation {\n  font-weight: bold;\n  font-size: 15px;\n  margin-bottom: 5px;\n}\n\n.changePictureBadge {\n  border-radius: 50% !important;\n  margin-left: 70%;\n  margin-bottom: 30%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _image_picker_image_picker_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../image-picker/image-picker.component */ "./src/app/shared/components/image-picker/image-picker.component.ts");
...
var ProfileInformationsComponent = /** @class */ (function () {
    function ProfileInformationsComponent(userService, productService, progressIndicatorService) {
        ...
        this.typeOfProduct = 'product';
    }
    ProfileInformationsComponent.prototype.ngOnInit = function () {
        var _this = this;
        // @ts-ignore
        this.profileItemData = Object.keys(this.profileItem).filter(function (value) { return _this.valuesToHide.indexOf(value) === -1; });
        this.profileItemData.sort();
        if (this.additionalValues) {
            this.additionalInformation = Object.keys(this.profileItem).filter(function (value) { return _this.additionalValues.indexOf(value) !== -1; });
    ...
    ProfileInformationsComponent.prototype.getValueString = function (key) {
        var value = this.profileItem[key.toString()];
        return (typeof value === 'boolean') ? this.valuesToName.get(value) : value;
    };
    ProfileInformationsComponent.prototype.getCategoryValue = function (key) {
        return this.profileItem[key].name;
    };
    ProfileInformationsComponent.prototype.onClickDelete = function () {
    ...
    ProfileInformationsComponent.prototype.onImagePicked = function (imageData) {
    ...
    ProfileInformationsComponent.prototype.onClickSave = function () {
        ...
        if (this.typeOfProfileItem === this.typeOfUser) {
            this.userService.updateUser(this.profileItem._id, body, this.imageFile).subscribe(function (data) {
                _this.displaySuccessSignifiers(_this.typeOfProfileItem);
                _this.updateComponent();
                _this.updateEvent.next();
                _this.imagePicker.resetImage();
            }, function (err) {
                _this.displayFailureSignifiers(_this.typeOfProfileItem);
                console.log(err);
            });
        }
        else if (this.typeOfProfileItem === this.typeOfProduct) {
            this.productService.updateProduct(this.profileItem._id, body, this.imageFile).subscribe(function (data) {
                _this.displaySuccessSignifiers(_this.typeOfProfileItem);
                _this.updateComponent();
                _this.updateEvent.next();
            }, function (err) {
    ...
    ProfileInformationsComponent.prototype.getAllChangedRows = function () {
        ...
        for (var i = 0; i < allRows.length; i++) {
            ...
            var oldValue = this.profileItem[key];
    ...
    ProfileInformationsComponent.prototype.displaySuccessSignifiers = function (typeOfProfileItem) {
        var _this = this;
    ...
    ProfileInformationsComponent.prototype.displayFailureSignifiers = function (typeOfProfileItem) {
        var _this = this;
        this.progressIndicatorService.dismissLoadingIndicator();
    ...
    ProfileInformationsComponent.prototype.retrieveNewProfileInformation = function () {
        var _this = this;
        if (this.typeOfProfileItem === this.typeOfUser) {
            this.userService.getSingleUser(this.profileItem._id).subscribe(function (data) {
                _this.profileItem = data;
                // @ts-ignore
                _this.profileItemData = Object.keys(_this.profileItem).filter(function (value) { return _this.valuesToHide.indexOf(value) === -1; });
                _this.profileItemData.sort();
            }, function (err) {
                console.log(err);
            });
        }
        if (this.typeOfProfileItem === this.typeOfProduct) {
            this.productService.getSingleProduct(this.profileItem._id).subscribe(function (data) {
                _this.profileItem = data;
                // @ts-ignore
                _this.profileItemData = Object.keys(_this.profileItem).filter(function (value) { return _this.valuesToHide.indexOf(value) === -1; });
                _this.profileItemData.sort();
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_image_picker_image_picker_component__WEBPACK_IMPORTED_MODULE_5__["ImagePickerComponent"], { static: false }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _image_picker_image_picker_component__WEBPACK_IMPORTED_MODULE_5__["ImagePickerComponent"])
    ], ProfileInformationsComponent.prototype, "imagePicker", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], ProfileInformationsComponent.prototype, "deleteEvent", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], ProfileInformationsComponent.prototype, "updateEvent", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], ProfileInformationsComponent.prototype, "profileItem", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], ProfileInformationsComponent.prototype, "additionalValues", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Boolean)
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Boolean)
    ], ProfileInformationsComponent.prototype, "hideDelete", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Array)
    ], ProfileInformationsComponent.prototype, "valuesToHide", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])('type'),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
    ], ProfileInformationsComponent.prototype, "typeOfProfileItem", void 0);
    ProfileInformationsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_core_services_userService_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"],
            _core_services_productService_product_service__WEBPACK_IMPORTED_MODULE_4__["ProductService"],
            src_app_core_services_progressIndicatorService_progress_indicator_service__WEBPACK_IMPORTED_MODULE_3__["ProgressIndicatorService"]])
...
/* harmony import */ var _components_image_picker_image_picker_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/image-picker/image-picker.component */ "./src/app/shared/components/image-picker/image-picker.component.ts");
...
var SharedModule = /** @class */ (function () {
    ...
    SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_components_rating_rating_component__WEBPACK_IMPORTED_MODULE_3__["RatingComponent"], _components_profile_informations_profile_informations_component__WEBPACK_IMPORTED_MODULE_5__["ProfileInformationsComponent"], _components_image_picker_image_picker_component__WEBPACK_IMPORTED_MODULE_6__["ImagePickerComponent"]],
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"]
            ],
            exports: [_components_rating_rating_component__WEBPACK_IMPORTED_MODULE_3__["RatingComponent"], _components_profile_informations_profile_informations_component__WEBPACK_IMPORTED_MODULE_5__["ProfileInformationsComponent"], _components_image_picker_image_picker_component__WEBPACK_IMPORTED_MODULE_6__["ImagePickerComponent"]]
        })
    ], SharedModule);
    return SharedModule;
}());
...
//# sourceMappingURL=default~pages-add-products-add-products-module~pages-admin-admin-module~pages-my-orders-my-orders-mo~cbac2fd6-es5.js.map