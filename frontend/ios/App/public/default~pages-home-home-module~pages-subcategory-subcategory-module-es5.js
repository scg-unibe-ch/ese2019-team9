...
var CarouselItemComponent = /** @class */ (function () {
    function CarouselItemComponent(router) {
        this.router = router;
    }
...
var CarouselComponent = /** @class */ (function () {
    function CarouselComponent(categoryService, platform) {
     ...
     */
    CarouselComponent.prototype.selectCarouselSize = function () {
     ...
     */
    CarouselComponent.prototype.prepareCarousel = function () {
        this.carouselItems = [];
        ...
        if (this.categoryCarousel && this.categoryCarousel.length >= 0) {
            ...
            for (var i = 0; i < this.categoryCarousel.length; i++) {
                for (var j = 0; j < this.categoryCarousel[i].length; j++) {
        ...
        if (this.productCarousel && this.productCarousel.length >= 0) {
            ...
            for (var i = 0; i < this.productCarousel.length; i++) {
    ...
    CarouselComponent.prototype.ngOnInit = function () {
        ...
        this.platform.resize.subscribe(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
     ...
     */
    CarouselComponent.prototype.selectNextItem = function () {
     ...
     */
    CarouselComponent.prototype.selectPreviousItem = function () {
     ...
     */
    CarouselComponent.prototype.selectCarouselItems = function (carouselSize, startingIndex) {
        this.itemsToDisplay = [];
        ...
        if (this.carouselItems.length < carouselSize) {
            ...
            for (var i = startingIndex; i < (carouselSize + startingIndex); i++) {
...
//# sourceMappingURL=default~pages-home-home-module~pages-subcategory-subcategory-module-es5.js.map