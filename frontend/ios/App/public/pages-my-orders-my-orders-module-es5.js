...
var MyOrdersPage = /** @class */ (function () {
    function MyOrdersPage(orderService, progressIndicatorService, authService) {
    ...
    MyOrdersPage.prototype.acceptOrder = function (orderId) {
        var _this = this;
        this.orderService.accept(orderId).subscribe(function (data) {
            ...
            console.log(err);
            _this.progressIndicatorService.presentToast('Orders could not be deleted', 'danger');
        });
    };
    MyOrdersPage.prototype.rejectOrder = function (orderId) {
        var _this = this;
        this.orderService.reject(orderId).subscribe(function (data) {
            _this.progressIndicatorService.presentToast('Orders successfully deleted');
            _this.reloadProducts();
        }, function (err) {
            console.log(err);
            _this.progressIndicatorService.presentToast('Orders could not be deleted', 'danger');
    ...
    MyOrdersPage.prototype.ngOnDestroy = function () {
        this.getOrders();
    };
    MyOrdersPage.prototype.getOrders = function () {
        var _this = this;
        this.userId = this.authService.getId();
        this.orderService.getBuyerOrders(this.userId).subscribe(function (data) {
    ...
    MyOrdersPage.prototype.reloadProducts = function () {
        this.loading = true;
        this.getOrders();
    };
    Object.defineProperty(MyOrdersPage.prototype, "isLoading", {
        get: function () {
            return this.loading;
        },
        enumerable: true,
