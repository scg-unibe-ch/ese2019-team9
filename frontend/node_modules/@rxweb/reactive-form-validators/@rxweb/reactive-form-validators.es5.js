...
var _a;
import { Directive, ElementRef, Inject, Injectable, Input, LOCALE_ID, NgModule, Renderer2, TemplateRef, ViewContainerRef, forwardRef } from '@angular/core';
                ...
                switch (property.propertyType) {
                    case PROPERTY:
                        if (!(entityObject[property.name] instanceof FormControl || entityObject[property.name] instanceof RxFormControl)) {
                            ...
                            var /** @type {?} */ sanitizeValue = _super.prototype.sanitizeValue.call(_this, instanceContainer, property.name, _super.prototype.getDefaultValue.call(_this, property, entityObject[property.name], formBuilderConfiguration), json.entityObject, Object.assign({}, json.entityObject));
    ...
    RxwebFormDirective.prototype.setConditionalValidator = function (controls) {
        ...
        Object.keys(controls).forEach(function (fieldName) {
            if (_this.validationRule.conditionalValidationProps && _this.validationRule.conditionalValidationProps[fieldName]) {
                ...
                var /** @type {?} */ fields = _this.validationRule.conditionalObjectProps.filter(function (t) { return t.objectPropName == fieldName; });
                var /** @type {?} */ nestedFormGroup_1 = /** @type {?} */ (controls[fieldName]);
                var /** @type {?} */ propWiseConditionalControls_1 = {};
