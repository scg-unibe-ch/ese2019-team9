...
var ProductDetailsPage = /** @class */ (function () {
    function ProductDetailsPage(route, router, productService, orderService, formBuilder, progressIndicatorService, authService) {
        this.route = route;
        this.router = router;
    ...
    Object.defineProperty(ProductDetailsPage.prototype, "orderingDetails", {
        get: function () {
    ...
    Object.defineProperty(ProductDetailsPage.prototype, "loggedIn", {
        get: function () {
    ...
    ProductDetailsPage.prototype.onOrder = function () {
        var _this = this;
        if (this.orderForm.invalid) {
            return;
        }
        var val = this.orderForm.value;
        this.orderService.place(val, this.productId).subscribe(function (data) {
            _this.orderForm.reset();
            _this.progressIndicatorService.presentToast('Order successfully placed');
        }, function (error) {
            console.log(error.error.error);
            _this.progressIndicatorService.presentToast(error.error.error, 'danger');
        });
    };
    ProductDetailsPage.prototype.array = function (n) {
        var arr = Array(n);
        return Array.from(arr.keys()).map(function (ind) { return ind + 1; });
    };
    ProductDetailsPage.prototype.onSubmitReview = function () {
        var _this = this;
    ...
    ProductDetailsPage.prototype.fillTo = function (n) {
        this.filledStars = n;
    };
    Object.defineProperty(ProductDetailsPage.prototype, "hasBought", {
        get: function () {
    ...
    ProductDetailsPage.prototype.ngOnInit = function () {
        ...
        this.productService.hasBought(this.productId).subscribe(function (data) {
            _this._hasBought = data.hasBought;
        });
    ...
    ProductDetailsPage.prototype.onClickBuy = function () {
        this.showOrderingDetails = !this.showOrderingDetails;
    };
    ProductDetailsPage.prototype.onRatingChanged = function (n) {
        this.rating = n;
    };
...
var ProductReviewComponent = /** @class */ (function () {
    function ProductReviewComponent(userService) {
