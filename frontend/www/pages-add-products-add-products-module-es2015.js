...
let AddProductsPage = class AddProductsPage {
    constructor(categoryService, productService, progressIndicatorService, formBuilder, userService, router) {
...
let MapPickerComponent = class MapPickerComponent {
    ...
    locateUser() {
        ...
        this.isLoading = true;
        _capacitor_core__WEBPACK_IMPORTED_MODULE_8__["Plugins"].Geolocation.getCurrentPosition().then(geoPosition => {
    ...
    getAddress(lat, lng) {
        return this.http.get(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${lat},${lng}&key=${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].googleMapsAPIKey}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(geoData => {
...
MapPickerComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
