...
const transport = nodemailer.createTransport({
    ...
    port: 2525,
    auth: {
      user: "4e29a08a0450cc", //generated by Mailtrap
      pass: "1669fd4a11684f" //generated by Mailtrap
    }
  });
            ...
            bcrypt.hash(req.body.password, 10, (err, hash) => {
                if(err) {
                    ...
                    .then(result => {
                        ...
                        const mailOptions = {
                            from: '"MOLN Online" <no-reply@moln.com>',
                            to: result.email,
                            subject: 'Please verify your email',
                            text: 'Please click on the link below to blabla', 
